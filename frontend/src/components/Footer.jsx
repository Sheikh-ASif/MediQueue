...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#181c2a] to-[#172043] text-[#f6f6fb] pt-16 pb-4 mt-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 px-8">
        ...
        <div className="flex flex-col justify-center">
          <div className="text-lg font-semibold mb-6 text-[#b196ff] tracking-wide">
            Quick Links
          </div>
