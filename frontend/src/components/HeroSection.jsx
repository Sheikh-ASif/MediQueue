...
//   return (
//     <div className="pb-0 mb-0 w-full max-w-full">
//       {/* PROFESSIONAL HERO SECTION WITHOUT IMAGE */}
//       <section className="relative w-full min-h-[400px] bg-gradient-to-br from-[#f0f7fd] via-[#e6f1fb] to-[#e9fafe] flex flex-col items-center justify-center px-6 py-14 rounded-none shadow-2xl overflow-hidden">
//         <div className="w-full max-w-3xl flex flex-col justify-center items-center text-center z-10 mx-auto">
//           <span className="inline-block px-6 py-2 bg-[#eaf4ff] text-[#3875c3] font-semibold text-base border border-[#e0e7ef] rounded-full mb-4 shadow">
//             🏥 Trusted by Thousands, Powered by Innovation
//           </span>
//           <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-3 bg-gradient-to-r from-[#4871ff] via-[#9f6ae4] to-[#fb5baa] bg-clip-text text-transparent">
//             Transforming Healthcare for the{" "}
//             <span className="bg-gradient-to-r from-[#3b82f6] via-[#8b5cf6] to-[#ec4899] bg-clip-text text-transparent">
//               Modern Patient
//             </span>
//           </h1>
//           <p className="text-[#374151] text-lg mt-2 mb-4 max-w-2xl mx-auto font-medium">
//             Experience seamless medical care with instant doctor bookings, advanced reminders, and secure records—all in one place.
//             <span className="block text-[#497fff] font-semibold mt-2">
//               No more queues. No more confusion.
//             </span>
//           </p>
//           {/* Badges */}
...
//               <div
//                 key={badge}
//                 className="px-5 py-2 rounded-full bg-gradient-to-r from-[#ede7ff] to-[#f0f7fd] text-[#8b5cf6] font-semibold border border-[#e0e7ef] shadow-sm"
//               >
//                 {badge}
//               </div>
//             ))}
...
//               <div
//                 key={stat.label}
//                 className="flex flex-col items-center p-5 bg-white/80 rounded-2xl shadow-lg min-w-[120px] border border-[#e0e7ef]"
//               >
//                 <span className="text-2xl font-bold text-[#497fff] mb-1">
//                   {stat.value}
//                 </span>
...
//         <div className="w-full text-center pt-6 text-[#7e6afb] text-md font-semibold flex flex-wrap justify-center gap-4">
//           <span>
//             <span className="bg-gradient-to-r from-[#8b5cf6] to-[#4871ff] px-3 py-1 rounded font-semibold text-white mr-2">🔒 Secure</span>
//             24/7 Emergency Care
//           </span>
//           <span className="hidden sm:inline">•</span>
//           <span>Appointment Tracking</span>
