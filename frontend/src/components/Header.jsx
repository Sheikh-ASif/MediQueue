...
const Header = () => {
  ...
  <p className="text-lg text-white">
    ...
    schedule appointments effortlessly
        ...
        <a className='flex flex-items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300' href="">
